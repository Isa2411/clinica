...
public class ingreso {
	...
	public ingreso(String id_ingreso, com.example.demo.model.paciente paciente, com.example.demo.model.medico medico, String habitacion, String cama, String fecha_ingreso, String fecha_salida, String estado) {
		this.id_ingreso = id_ingreso;
	...
	public com.example.demo.model.paciente getPaciente() {
		return paciente;
	}

	public void setPaciente(com.example.demo.model.paciente paciente) {
		this.paciente = paciente;
	}

	public com.example.demo.model.medico getMedico() {
		return medico;
	}

	public void setMedico(com.example.demo.model.medico medico) {
		this.medico = medico;
	}
